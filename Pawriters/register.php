...
<div class="d-flex align-items-center justify-content-center min-vh-100">
    <div class="card shadow-lg border-0 p-4" style="width: 380px; border-radius: 18px;">
        ...
        <div class="text-center mb-4">
            ...
            <h3 class="fw-bold mt-3 text-success">Join Pawriterss</h3>
            <p class="text-muted">Bergabung dengan komunitas penulis</p>
        </div>

        <form action="aksi/proses_register.php" method="POST">
            ...
            <div class="mb-3">
                <div class="input-group input-group-lg">
                    ...
                    <input type="text" name="nama" class="form-control bg-white border-start-0" placeholder="Nama Lengkap" required>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-success w-100 btn-lg mb-3" style="border-radius: 10px;">
                Daftar Akun
            </button>
